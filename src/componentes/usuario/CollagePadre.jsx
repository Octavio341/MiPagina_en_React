...
import Collage from "./Collage";       // Aquí debes tener un componente que muestre las fichas en forma de grid (portada, título, etc)
import CarruselFicha from "./Carrusel"; // El carrusel con toda la info detallada
